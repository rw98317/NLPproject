...
注解文件：instance_train2014.json,instance_val2014.json(注释文件).放置在`data preperation/caption data`下，内容：</br>
```
...
`TRAIN_name_coco.json`  (存储图像名,例如：`COCO_train2014_000000205672.jpg`，按顺序对应于`(VAL,TEST)TRAIN_CAPTIONS_coco.json`的字幕) </br>
